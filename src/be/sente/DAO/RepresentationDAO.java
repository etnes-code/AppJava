	...
	public boolean create(Representation obj) {
		try {
			...
			this.connect.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY)
					.executeUpdate("INSERT INTO Representation(HeureDebut,HeureFin,OuverturePorte,IdSpectacle) VALUES('"+obj.getHeureDebut()+"','"+obj.getHeureFin()+"','"+obj.getOuverturePorte()+"',"+max_id+")");
			return true;
